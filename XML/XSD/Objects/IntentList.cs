...
public partial class IntentList
{
    ...
    private static XmlSerializer SerializerXML
    {
        get
        {
            if ((_serializer == null))
            {
                _serializer = new XmlSerializerFactory().CreateSerializer(typeof(IntentList));
            }
            return _serializer;
        }
    }
    ...
    /// <summary>
    /// Deserializes IntentList object
    /// </summary>
    ...
    public static IntentList Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((IntentList)(SerializerXML.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((IntentList)(SerializerXML.Deserialize(s)));
    }
    #endregion
