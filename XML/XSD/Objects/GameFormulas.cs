...
public partial class GameFormulas
{
    ...
    private PlayerFormulas _player;
    private MonsterFormula[][] _monster;
    private static XmlSerializer _serializer;
    #endregion
    
    public PlayerFormulas Player
    {
        get
        {
            return _player;
    ...
    [XmlArrayItemAttribute("Variance", IsNullable=false, NestingLevel=1)]
    public MonsterFormula[][] Monster
    {
        get
        {
            return _monster;
