...
public partial class SpawnMap
{
    ...
    private static XmlSerializer SerializerXML
    {
        get
        {
            if ((_serializer == null))
            {
                _serializer = new XmlSerializerFactory().CreateSerializer(typeof(SpawnMap));
            }
            return _serializer;
        }
    }
    ...
    public static SpawnMap Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((SpawnMap)(SerializerXML.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((SpawnMap)(SerializerXML.Deserialize(s)));
    }
    #endregion
