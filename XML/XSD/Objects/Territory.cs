...
public partial class Territory
{
    ...
    private static XmlSerializer SerializerXML
    {
        get
        {
            if ((_serializer == null))
            {
                _serializer = new XmlSerializerFactory().CreateSerializer(typeof(Territory));
            }
            return _serializer;
        }
    }
    ...
    public static Territory Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Territory)(SerializerXML.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Territory)(SerializerXML.Deserialize(s)));
    }
    #endregion
