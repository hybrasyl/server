...
public partial class CastableRestrictions
{
    ...
    private static XmlSerializer Serializer
    {
        get
        {
            if ((serializer == null))
            {
                serializer = new XmlSerializerFactory().CreateSerializer(typeof(CastableRestrictions));
            }
            return serializer;
        }
    }
    ...
    /// <summary>
    /// Serializes current CastableRestrictions object into an XML string
    /// </summary>
    ...
    /// <summary>
    /// Deserializes workflow markup into an CastableRestrictions object
    /// </summary>
    ...
    public static CastableRestrictions Deserialize(string input)
    {
        StringReader stringReader = null;
        try
        {
            stringReader = new StringReader(input);
            return ((CastableRestrictions)(Serializer.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static CastableRestrictions Deserialize(Stream s)
    {
        return ((CastableRestrictions)(Serializer.Deserialize(s)));
    }
    #endregion
    
    /// <summary>
    /// Serializes current CastableRestrictions object into file
    /// </summary>
    ...
    public static CastableRestrictions LoadFromFile(string fileName)
    {
