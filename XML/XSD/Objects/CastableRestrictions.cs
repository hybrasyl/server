...
public partial class CastableRestrictions
{
    ...
    private static XmlSerializer SerializerXML
    {
        get
        {
            if ((_serializer == null))
            {
                _serializer = new XmlSerializerFactory().CreateSerializer(typeof(CastableRestrictions));
            }
            return _serializer;
        }
    }
    ...
    /// <summary>
    /// Serialize CastableRestrictions object
    /// </summary>
    ...
    public static CastableRestrictions Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((CastableRestrictions)(SerializerXML.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((CastableRestrictions)(SerializerXML.Deserialize(s)));
    }
    #endregion
