...
public partial class Categories
{
    ...
    private static XmlSerializer SerializerXML
    {
        get
        {
            if ((_serializer == null))
            {
                _serializer = new XmlSerializerFactory().CreateSerializer(typeof(Categories));
            }
            return _serializer;
        }
    }
    ...
    /// <summary>
    /// Deserializes Categories object
    /// </summary>
    ...
    public static Categories Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Categories)(SerializerXML.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Categories)(SerializerXML.Deserialize(s)));
    }
    #endregion
