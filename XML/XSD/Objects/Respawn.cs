...
public partial class Respawn
{
    ...
    private static XmlSerializer SerializerXML
    {
        get
        {
            if ((_serializer == null))
            {
                _serializer = new XmlSerializerFactory().CreateSerializer(typeof(Respawn));
            }
            return _serializer;
        }
    }
    ...
    public static Respawn Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Respawn)(SerializerXML.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Respawn)(SerializerXML.Deserialize(s)));
    }
    #endregion
