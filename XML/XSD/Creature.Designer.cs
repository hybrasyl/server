...
namespace Hybrasyl.Xml.Creature
{
    ...
    public partial class Spawn
    {
        ...
        public Spawn()
        {
            _castables = new List<Castable>();
            _loot = new LootList();
            _stats = new Stats();
            _defense = new Defense();
            _damage = new Damage();
            _respawn = new Respawn();
            _intents = new IntentList();
            _script = new CreatureScript();
            _variance = ((float)(1F));
        }
    ...
    public partial class Npc
    {
        ...
        public Npc()
        {
            _inventory = new NpcInventory();
            _roles = new NpcRoleList();
    ...
    public partial class NpcRoleList
    {
        ...
        public NpcRoleList()
        {
            _bank = new NpcRoleBank();
            _repair = new NpcRoleRepair();
            _post = new NpcRolePost();
            _vend = new NpcRoleVend();
            _train = new List<NpcRoleTrainCastable>();
        }
    ...
    public partial class NpcRoleVend
    {
        ...
        public NpcRoleVend()
        {
            ...
            _items = new List<NpcRoleVendItem>();
        }
