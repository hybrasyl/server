...
{
    public static MessagingResponse UnknownError =>
        new()
        {
    ...
    public static MessagingResponse BoardList(GuidReference userRef)
    {
    ...
    public static MessagingResponse GetMessageList(GuidReference userRef, ushort boardId,
    ...
    public static MessagingResponse DeleteMessage(GuidReference userRef, ushort boardId,
        ushort postId)
    {
    ...
    public static MessagingResponse SendMessage(GuidReference senderRef, ushort boardId,
    ...
    public static MessagingResponse HighlightMessage(GuidReference userRef, ushort boardId,
        short postId)
    {
        var response = string.Empty;
        var success = false;
