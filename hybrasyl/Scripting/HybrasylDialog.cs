...
public class HybrasylDialog
{
    ...
    /// <summary>
    ///     Set the display sprite for this specific dialog to an NPC / creature sprite. This is the sprite that is displayed
    ///     on the left hand side when a user views a dialog.
    /// </summary>
    ...
    /// <summary>
    ///     Set the display sprite for this specific dialog to an item sprite. This is the sprite that is displayed on the left
    ///     hand side when a user views a dialog.
    /// </summary>
