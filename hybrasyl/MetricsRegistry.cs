    ...
    public static Dictionary<int, TimerOptions> ControlMessageTimerIndex = new Dictionary<int, TimerOptions>()
{
       ...
       {13, ControlMessage_GlobalMessage},
    ...
    public static TimerOptions ControlMessage_GlobalMessage => new TimerOptions
    {
        Name = "GlobalMessage Control Message",
        MeasurementUnit = Unit.Requests,
        DurationUnit = TimeUnit.Milliseconds,
        RateUnit = TimeUnit.Milliseconds,
    };

    public static TimerOptions ControlMessage_RemoveReactor => new TimerOptions
    {
        Name = "RemoveReactor Control Message",
        MeasurementUnit = Unit.Requests,
        DurationUnit = TimeUnit.Milliseconds,
        RateUnit = TimeUnit.Milliseconds,
    };

    public static TimerOptions ControlMessage_ModifyStats => new TimerOptions
    {
        Name = "ModifyStats Control Message",
        MeasurementUnit = Unit.Requests,
        DurationUnit = TimeUnit.Milliseconds,
        RateUnit = TimeUnit.Milliseconds,
    };

    public static TimerOptions ControlMessage_ProcessProc => new TimerOptions
    {
        Name = "ProcessProc Control Message",
        MeasurementUnit = Unit.Requests,
        DurationUnit = TimeUnit.Milliseconds,
        RateUnit = TimeUnit.Milliseconds,
    };
